...
var no = function() {
  $('#choice3').append("'Very few people have the honor of coming to Bigglesworth Fortress and you come here to waste my time? " +
    ...
    "You are left wondering what mysterys await inside. Perhaps when you have a problem that Godfred can help with you...you will know");
  $('#pas').slideToggle();
};
var lt = function(){
